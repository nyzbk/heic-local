 ...
 * sidecar WASM/data files `new URL("./pglite.data", import.meta.url)` expects.
 * Without them `vite preview` dies on PGLite bootstrap.
 */
  ...
  return {
    ...
    closeBundle: {
      ...
      handler() {
        ...
        if (!existsSync(srcDir) || !existsSync(join(destDir, "electric-sql__pglite.mjs"))) {
          return;
        }
